...
class DimensionAnomalyAdmin(CampaignAdminMixin, PolymorphicChildModelAdmin):
    base_model = GameObject
    show_in_index = True
    form = DimensionAnomalyForm
    list_display = ('id', 'colored_effect', 'level_display', 'known_status', 'is_active', 'dimension_link',
                    'position_link', 'campaign_link', 'created_at', 'updated_at')
