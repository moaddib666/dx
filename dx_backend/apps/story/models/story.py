...
class Story(BaseModel):
    ...
    image = models.ImageField(upload_to='story/story', null=True, blank=True, help_text="Optional URL to an image representing the story")
...
class Chapter(BaseModel):
    ...
    title = models.CharField(max_length=255)
    description = models.TextField()
    image = models.ImageField(upload_to='story/chapter', null=True, blank=True, help_text="Optional URL to an image representing the chapter")
