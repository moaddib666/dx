  ...
  <div class="page-container">
    ...
    <div class="player-home-dashboard">
      ...
      <div v-if="loading" class="loading-overlay">
        ...
        <div class="loading-text">{{ t('playerDashboard.loading') }}</div>
        <div class="loading-message">{{ t('playerDashboard.preparingAdventure') }}</div>
      </div>
      ...
      <div v-else-if="!hasCampaigns" class="no-campaigns-overlay">
        <div class="no-campaigns-content">
          ...
          <h2 class="warning-title">{{ t('playerDashboard.noCampaigns') }}</h2>
          <p class="warning-message">
            {{ t('playerDashboard.noCampaignsMessage') }}
          </p>
          <div class="action-buttons">
            <a href="#" class="discord-button" @click.prevent="openDiscord">
              ...
              {{ t('playerDashboard.joinDiscord') }}
            </a>
            <a href="#" class="faq-button" @click.prevent="goToFaq">
              {{ t('playerDashboard.readFAQ') }}
            </a>
          </div>
        </div>
      </div>
  ...
  methods: {
    ...
    createCharacter() {
      ...
      if (!this.selectedCampaignId) {
        ...
        const goToDiscord = confirm(this.t('playerDashboard.noCampaignSelected'));
