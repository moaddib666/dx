<template>
  <div class="page-container">
    <ZoomModal
        ...
        @close="closeZoom"
    />
    <HeroBackground @toggle-zoom="toggleZoom" id="background"/>
...
#background {
  background-image: url('@/assets/images/backgrounds/common/moaddib_Desolate_corrupted_wasteland_with_twisted_terrain_jag_072aff1a-d29b-4f13-a8a6-57bab975d17b_3.png');
