...
.rpg-stat-bar {
  ...
  align-items: center;
  background: url("@/assets/rpg_bars/action_points_bar_with_border.png") no-repeat left top;
...
.rpg-stat-bar__wrapper {
  ...
  align-items: center;
  background-size: contain;
  mask: url("@/assets/rpg_bars/action_points_mask_inverted.png") no-repeat center;
  mask-size: contain;
}
.rpg-stat-bar__fill {
  background: url("@/assets/rpg_bars/action_points_content.png") no-repeat center;
  background-size: cover;
  width: 100%;
  height: 100%;
  transition: width 0.3s ease;

  box-shadow: inset 0 0 1.2rem rgba(111, 251, 111, 0.72);
  border-radius: 3rem;
}
.rpg-stat-bar__label {
  position: absolute;
